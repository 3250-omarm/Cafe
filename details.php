...
<div id="container">
	<div class="nav">	
		...
		?>
				<div>
					<center>
						<img class="img-polaroid" style="width:380px; height:380px;border-radius:20px;padding:10px;" src="photo/<?php echo $row['product_image']; ?>">
						<p class="text-uppercase bg-primary" style='font-size: 20px; color:rgb(135, 19, 61);font-weight:bold;'><?php echo $row['product_name']?></p>
						<p class="text-uppercase" style='font: size 18px; font-weight:bold; color:rgb(238, 66, 129);'>Price: <?php echo $row['product_price']?> $</p>
